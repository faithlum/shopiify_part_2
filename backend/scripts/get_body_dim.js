...
fbxLoader.load(
  // 'models/laughing_tiff.fbx',
  'C:/Users/flum3/Desktop/1_simflection/shopify_gallery_walk/3-d-tryon/backend/uploads/avatar.fbx',
  // 'models/joseph_walking.fbx',
  (fbx) => {
    avatar = fbx;
    avatar.visible = true;
...
fbxLoader.load('C:/Users/flum3/Desktop/1_simflection/shopify_gallery_walk/3-d-tryon/backend/scripts/tpose.fbx.', (fbx) => {
  tpose = fbx;
  tpose.visible = false;
